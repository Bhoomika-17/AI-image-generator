  ...
  return (
    <section className="max-w-7xl mx-auto">
        <div>
            ...
            <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">Generate imaginative and visually stunning images through AI image generator and share them with the community</p>
        </div>
